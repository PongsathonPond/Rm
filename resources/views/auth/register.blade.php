<x-guest-layout>
    <x-auth-card>
        <x-splade-form action="{{ route('register') }}" class="space-y-4">
            ...
            <x-splade-input id="first_name" type="text" name="first_name" :label="__('FirstName')" required />
            <x-splade-input id="last_name" type="text" name="last_name" :label="__('LastName')" required />
            <!-- <x-splade-input id="first_name" type="text" name="first_name" :label="__('FirstName')"  />
            <x-splade-input id="last_name" type="text" name="last_name" :label="__('LastName')"  /> -->
